...
C
      ...
      CALL SPAKUJ(ALSK,A(LMAXA),AE(LSKEXX),AE(LLMXX),NDXY)
      CALL SPAKUJ(ALSK,A(LMAXA),AE(LSKEXY),AE(LLMXY),NDXY)
      ELSE
         CALL sparseassembler_addelemmatrix(NDXY,AE(LLMXX),AE(LSKEXX))
         CALL sparseassembler_addelemmatrix(NDXY,AE(LLMXY),AE(LSKEXY))
            ENDIF
  100 CONTINUE
C
      NPROS=4*NE*IDVA
